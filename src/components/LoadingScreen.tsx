...
export const LoadingScreen = () => {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div 
        className="absolute inset-0 bg-gradient-to-br from-blue-50 to-indigo-100 animate-fade-in"
        style={{
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-white/20 backdrop-blur-md p-12 rounded-3xl shadow-2xl border border-white/20 flex flex-col items-center gap-8 animate-fade-in-up">
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold text-blue-900 mb-3 drop-shadow-sm">
